  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-surface-container border border-outline-variant/15 rounded-2xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        {/* Type selector */}
        <div className="flex bg-surface rounded-xl p-1 mb-5 border border-outline-variant/10">
          {([
        ...
        <div className="bg-surface-container-lowest rounded-xl p-3 mb-4">
          <p className="text-[10px] text-on-surface-variant font-medium uppercase tracking-widest mb-1">Formato esperado</p>
        ...
        <div className="mb-4">
          <input
            ...
            accept=".csv,.txt"
            onChange={handleFile}
            className="w-full text-sm text-outline file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-none file:bg-surface-container-lowest file:text-sm file:text-outline file:cursor-pointer hover:file:bg-surface-container file:transition-colors"
          />
        </div>
                ...
                <thead>
                  <tr>
                    {parsed.headers.map((h) => (
                      <th key={h} className="px-3 py-2 text-left text-on-surface-variant font-medium uppercase tracking-widest">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
